...
function slt_write(F::String,t0::DateTime,ch::Array{Int8},bm::Array{Int8},D::Array{Int16};eddy_ver::Int=0)
	F = F * string(Int64(Dates.Year(t0))) * @sprintf("%03u",Int64(floor(Float64(t0 - DateTime(Dates.Year(t0)))/1000/60/60/24) + 1)) * @sprintf("%02u",Int64(Dates.Hour(t0))) * @sprintf("%02u",Int64(Dates.Minute(t0))) * ".slt"
	...
	yr1 = convert(Int8,floor(convert(Int64,Dates.Year(t0))/100))
	yr2 = convert(Int8,convert(Int64,Dates.Year(t0)) - 100*floor(convert(Int64,Dates.Year(t0))/100))
