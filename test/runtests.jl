...
@testset "====================== Campbell Scientific TESTS  ======================" begin
...
@testset "======================= Los Gatos Research TESTS  =======================" begin
...
@testset "============================== Licor TEST  ==============================" begin
	...
	elseif Sys.iswindows()
		temp = read(`$exe7z x $F1 -y -o$dest`,String);
	end
